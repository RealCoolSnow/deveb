...
export default function MobileFooter({ tab }) {
  return (
    <div className={`m-footer ${ !tab ? 'brief' : '' }`}>

        <a href='mailto:am@am-arc.com' target="_blank" rel="noopener noreferrer" className='mail'>
          am@am-arc.com
        </a>

        <span className='address'>
          Mechnykova St, Parus building, office 124, Kyiv, Ukraine
        </span>
        ...
        <div className="footer-social">
          ...
          <a href='mailto:am@am-arc.com' target="_blank" rel="noopener noreferrer">
            <svg id="Group_748" data-name="Group 748" xmlns="http://www.w3.org/2000/svg" width="28.028" height="21" viewBox="0 0 28.028 21">
          ...
          {/* Telegram */}
          <a href='https://t.me/am-arc' target="_blank" rel="noopener noreferrer">
